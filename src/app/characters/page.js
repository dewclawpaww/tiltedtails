...
function CharacterCard({ name, species, height, imgSrc, bio }) {
  ...
  return (
    <div 
      className="border border-gray-700 p-6 rounded-lg bg-gray-900 shadow-lg flex flex-col items-center transition-transform transform hover:scale-105 hover:brightness-110"
    >
      {/* Character Image */}
      ...
      {/* Expandable Bio with Smooth Transition */}
      <button
      ...
      <div
        className={`mt-4 text-gray-300 text-left overflow-hidden transition-all duration-500 ease-in-out ${
      ...
      <div className="relative z-10 flex flex-col items-center w-full mt-24 px-6 pb-16">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
          ...
          <CharacterCard
            ...
            bio={
              <p className="leading-relaxed">
                Paw is the kind of fox who always lands on his feet—whether by skill or sheer dumb luck. 
          ...
          <CharacterCard
            ...
            bio={
              <p className="leading-relaxed">
                Belle was born into wealth, elegance, and a life of comfort. She always had someone to drive her, 
